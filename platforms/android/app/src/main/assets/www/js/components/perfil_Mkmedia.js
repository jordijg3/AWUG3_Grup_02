var listaJson7 = [
    ...
    {idproyecto: "22", nombre: " ShowReel", descripcion: " Sed eget eros sit amet elit euismod bibendum eu et", img1:"img/projects/1video02.jpg", img2:"img/projects/1video03.jpg", img3:"img/projects/1video04.jpg"},
    {idproyecto: "23", nombre: " JOURNEY SAATCHI IS", descripcion: " Sed eget eros sit amet elit euismod bibendum eu et", img1:"img/projects/2video02.jpg", img2:"img/projects/2video03.jpg", img3:"img/projects/2video04.jpg"},
    {idproyecto: "24", nombre: " No Signal", descripcion: " Sed eget eros sit amet elit euismod bibendum eu et", img1:"img/projects/3video02.jpg", img2:"img/projects/3video03.jpg", img3:"img/projects/3video04.jpg"},


	
];

const MkmediaTemplate = {props: [], 
                        
                      
        created: function(){
            this.proyectosperfiles = listaJson7;
        ...
        <div style="background-color: #fafafa;">
              ...
              <div class="md-layout md-gutter" style="padding: 5%;">
                    ...
                    <div class="md-layout-item md-size-25">
                        <md-avatar class="md-large" style="width: 100%;height: 100%;">
                                <img src="img/user/fotoe2.jpg" alt="People">
                        </md-avatar>
                    </div>

                    <div class="md-layout-item" style="margin-top:3%"> 
                    <span class="md-title" style="text-transform: initial;">Mk Media</span><br>
              ...
              <div class="md-layout md-gutter" style="padding: 0% 5% 5% 5%;">
                    ...
                    <div class="md-layout-item" style="text-align:center;">
                        <span class="md-body-1"><b>13</b></span><br>
                        <span class="md-caption">Seguidos</span>
                    </div>

                     <div class="md-layout-item" style="text-align:center;">
                        <span class="md-body-1"><b>678</b></span><br>
                 ...
                 <md-tabs md-alignment="centered" class="md-transparent" style="border-top: 1px solid #efefef;height: 100%; background-color: rgb(250, 250, 250);">
                      ...
                      <md-tab id="tab-proyectos" md-label="Proyectos" style="border-bottom: 1px solid #f2f2f2; background-color:#fafafa; height: 658px;">
                                  ...
                                  <div class="card-expansion"  @click="goToShow()" style="padding-bottom: 16px;" v-for="proyectoperfiles in proyectosperfiles">
