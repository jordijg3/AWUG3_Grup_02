var listaJson2 = [
       {idproyecto: "44", nombre: "Pink", descripcion: "Collection of some woeks made in 2017", img1:"img/projects/14video01.jpg", img2:"img/projects/14video02.jpg", img3:"img/projects/14video03.jpg"}, 
    {idproyecto: "43", nombre: "Filling spaces", descripcion: "The connection between light and space", img1:"img/projects/13video01.jpg", img2:"img/projects/13video02.jpg", img3:"img/projects/13video03.jpg"},   
    {idproyecto: "45", nombre: "Starbucks: PlayWithUs", descripcion: "The final result is a short advertising which uses the hashtag #playwithus in order to invite all the people to feel a little easy and have fun with Starbucks's world", vid:"vid/projects/15video01.mp4", img1:"img/projects/15video02.jpg", img2:"img/projects/15video03.jpg", img3:"img/projects/15video04.jpg"},
	
];

const BernatTemplate = {props: [], 
                        
        created: function(){
            this.proyectosperfiles = listaJson2;
        ...
        methods: {
            ...
            goToSeguidorBernat: function(){                
                    this.$router.push('seguidor_bernat');
                },
            
            goToSeguidoBernat: function(){                
                    this.$router.push('seguido_bernat');
                },
        ...
        <div style="background-color: #fafafa;">
              ...
              <div class="md-layout md-gutter" style="padding: 5%;">
                    ...
                    <div class="md-layout-item md-size-25">
                        <md-avatar class="md-large" style="width: 100%;height: 100%;">
                                <img src="img/user/fotop5.jpg" alt="People">
                        </md-avatar>
                    </div>

                    <div class="md-layout-item" style="margin-top:3%"> 
                    <span class="md-title" style="text-transform: initial;">Bernat Valls</span><br>
              ...
              <div class="md-layout md-gutter" style="padding: 0% 5% 5% 5%;">
                    ...
                    <div class="md-layout-item" style="text-align:center;">
                        ...
                        <span class="md-caption"  @click="goToSeguidoBernat()">Seguidos</span>
                    </div>

                     <div class="md-layout-item" style="text-align:center;">
                        <span class="md-body-1"><b>5</b></span><br>
                        <span class="md-caption" @click="goToSeguidorBernat()">Seguidores</span>
                    </div>
                 ...
                 <md-tabs md-alignment="centered" class="md-transparent" style="border-top: 1px solid #efefef;height: 100%; background-color: rgb(250, 250, 250);">
                      ...
                      <md-tab id="tab-proyectos" md-label="Proyectos" style="border-bottom: 1px solid #f2f2f2; background-color:#fafafa; height: 658px;">
                                  ...
                                  <div class="card-expansion"  @click="goToPink()" style="padding-bottom: 16px;" v-for="proyectoperfiles in proyectosperfiles">
