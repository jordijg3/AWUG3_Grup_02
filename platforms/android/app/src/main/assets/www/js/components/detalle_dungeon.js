...
<div style="background-color: #fafafa;">
  ...
  <div class="md-layout md-gutter" style="padding: 2%; border-bottom: 1px solid #f2f2f2;">
    ...
    <div class="md-layout-item"> <span class="md-title" style="text-transform: initial;">Dungeon Hunter</span><br></div>
...
<iframe src="https://player.vimeo.com/video/268113260?autoplay=1&loop=0&autopause=0" width="auto" height="auto" frameborder="0" webkitallowfullscreen mozallowfullscreen allowfullscreen style="min-width:415px; min-height:235px;"></iframe>
   ...
   <div class="card-expansion" style="padding-top: 20px;">
    ...
    <div class="md-layout-item" style="padding-bottom: 16px;"><img src="img/projects/4video02.jpg" alt="People"></div>
    <div class="md-layout-item" style="padding-bottom: 16px;"><img src="img/projects/4video03.jpg" alt="People"></div>
    <div class="md-layout-item" style="padding-bottom: 16px;"><img src="img/projects/4video04.jpg" alt="People"></div>
