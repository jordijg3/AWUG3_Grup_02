var listaJson6 = [
        ...
        {idproyecto: "58", nombre: "Du Squad", descripcion: "New commercial for Peppermelon", img1:"img/projects/233d01.jpg", img2:"img/projects/233d02.jpg", img3:"img/projects/233d03.jpg"}, 
        {idproyecto: "59", nombre: "Ice Cream Truck", descripcion: "A 3D funny truck", sketch:"618a5cd368dd40218d16ea1053c013ab", img1:"img/projects/243d02.jpg", img2:"img/projects/243d03.jpg", img3:"img/projects/243d04.jpg"},
        {idproyecto: "60", nombre: "Animated humanoid robot", descripcion: "A 3D animated character", sketch:"8993602ca91f4c499e690e5dae19f978", img1:"img/projects/253d02.jpg", img2:"img/projects/253d03.jpg", img3:"img/projects/253d04.jpg"},
 

	
];

const MarthaTemplate = {props: [], 
                        
                      
        created: function(){
            this.proyectosperfiles = listaJson6;
        ...
        methods: {
            ...
            goToSeguidorMartha: function(){                
                    this.$router.push('seguidor_martha');
                },
            
            goToSeguidoMartha: function(){                
                    this.$router.push('seguido_martha');
                },
        ...
        <div style="background-color: #fafafa;">
              ...
              <div class="md-layout md-gutter" style="padding: 5%;">
                    ...
                    <div class="md-layout-item md-size-25">
                        <md-avatar class="md-large" style="width: 100%;height: 100%;">
                                <img src="img/user/fotop10.jpg" alt="People">
                        </md-avatar>
                    </div>

                    <div class="md-layout-item" style="margin-top:3%"> 
                    <span class="md-title" style="text-transform: initial;">Martha Flat</span><br>
              ...
              <div class="md-layout md-gutter" style="padding: 0% 5% 5% 5%;">
                    ...
                    <div class="md-layout-item" style="text-align:center;">
                        ...
                        <span class="md-caption"  @click="goToSeguidoMartha()">Seguidos</span>
                    </div>

                     <div class="md-layout-item" style="text-align:center;">
                        <span class="md-body-1"><b>2</b></span><br>
                        <span class="md-caption" @click="goToSeguidorMartha()">Seguidores</span>
                    </div>
                 ...
                 <md-tabs md-alignment="centered" class="md-transparent" style="border-top: 1px solid #efefef;height: 100%; background-color: rgb(250, 250, 250);">
                      ...
                      <md-tab id="tab-proyectos" md-label="Proyectos" style="border-bottom: 1px solid #f2f2f2; background-color:#fafafa; height: 658px;">
                                  ...
                                  <div class="card-expansion"  @click="goToDu()" style="padding-bottom: 16px;" v-for="proyectoperfiles in proyectosperfiles">
