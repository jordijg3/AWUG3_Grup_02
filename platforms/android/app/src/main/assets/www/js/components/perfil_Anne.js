var listaJson1 = [
        ...
        {idproyecto: "40", nombre: "Lenovo Yoga 920", descripcion: "Creation of a new commercial for the lastest Lenovo flagship laptop product", img1:"img/projects/10video02.jpg", img2:"img/projects/10video03.jpg", img3:"img/projects/10video04.jpg"},
        {idproyecto: "41", nombre: "Volume", descripcion: "A piece of random figures and their animations", img1:"img/projects/11video02.jpg", img2:"img/projects/11video03.jpg", img3:"img/projects/11video04.jpg"},
        {idproyecto: "42", nombre: "New Balance", descripcion: "Creation of a new commercial for New Balance", img1:"img/projects/12video02.jpg", img2:"img/projects/12video03.jpg", img3:"img/projects/12video04.jpg"},
	
];

const AnneTemplate = {props: [], 
                        
                      
        created: function(){
            this.proyectosperfiles = listaJson1;
        ...
        methods: {
            ...
            goToSeguidorAnne: function(){                
                    this.$router.push('seguidor_anne');
                },
            
            goToSeguidoAnne: function(){                
                    this.$router.push('seguido_anne');
                },
        ...
        <div style="background-color: #fafafa;">
              ...
              <div class="md-layout md-gutter" style="padding: 5%;">
                    ...
                    <div class="md-layout-item md-size-25">
                        <md-avatar class="md-large" style="width: 100%;height: 100%;">
                                <img src="img/user/fotop4.jpg" alt="People">
                        </md-avatar>
                    </div>

                    <div class="md-layout-item" style="margin-top:3%"> 
                    <span class="md-title" style="text-transform: initial;">Anne Sper</span><br>
              ...
              <div class="md-layout md-gutter" style="padding: 0% 5% 5% 5%;">
                    ...
                    <div class="md-layout-item" style="text-align:center;">
                        <span class="md-body-1"><b>4</b></span><br>
                        <span class="md-caption"  @click="goToSeguidoAnne()">Seguidos</span>
                    </div>

                     <div class="md-layout-item" style="text-align:center;">
                        <span class="md-body-1"><b>4</b></span><br>
                        <span class="md-caption" @click="goToSeguidorAnne()">Seguidores</span>
                    </div>
