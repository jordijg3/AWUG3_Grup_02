var listaJson4 = [
    ...
    {idproyecto: "11", nombre: "Thanos", descripcion: " Nulla pharetra orci semper rutrum aliquet. Maecena", img1:"img/projects/23d02.jpg", img2:"img/projects/23d03.jpg", img3:"img/projects/23d04.jpg"},
    {idproyecto: "14", nombre: "Dinosaur", descripcion: " Nulla pharetra orci semper rutrum aliquet. Maecena", img1:"img/projects/53d01.jpg", img2:"img/projects/53d02.jpg", img3:"img/projects/53d03.jpg"},
    {idproyecto: "20", nombre: "Stadium", descripcion: " Nulla pharetra orci semper rutrum aliquet. Maecena", img1:"img/projects/113d01.jpg", img2:"img/projects/113d02.jpg", img3:"img/projects/113d03.jpg"},

];

const EvolveTemplate = {props: [], 
                        
        created: function(){
            this.proyectosperfiles = listaJson4;
        ...
        <div style="background-color: #fafafa;">
              ...
              <div class="md-layout md-gutter" style="padding: 5%;">
                    ...
                    <div class="md-layout-item md-size-25">
                        <md-avatar class="md-large" style="width: 100%;height: 100%;">
                                <img src="img/user/fotoe6.jpg" alt="People">
                        </md-avatar>
                    </div>

                    <div class="md-layout-item" style="margin-top:3%"> 
                    <span class="md-title" style="text-transform: initial;">Evolve Games</span><br>
              ...
              <div class="md-layout md-gutter" style="padding: 0% 5% 5% 5%;">
                    ...
                    <div class="md-layout-item" style="text-align:center;">
                        <span class="md-body-1"><b>105</b></span><br>
                        <span class="md-caption">Seguidos</span>
                    </div>

                     <div class="md-layout-item" style="text-align:center;">
                        <span class="md-body-1"><b>45</b></span><br>
                        <span class="md-caption">Seguidores</span>
                    </div>

                     <div class="md-layout-item" style="text-align:center;">
                        <span class="md-body-1"><b>0</b></span><br>
                 ...
                 <md-tabs md-alignment="centered" class="md-transparent" style="border-top: 1px solid #efefef;height: 100%; background-color: rgb(250, 250, 250);">
                      ...
                      <md-tab id="tab-proyectos" md-label="Proyectos" style="border-bottom: 1px solid #f2f2f2; background-color:#fafafa; height: 658px;">
                                  ...
                                  <div class="card-expansion"  @click="goToThanos()" style="padding-bottom: 16px;" v-for="proyectoperfiles in proyectosperfiles">
