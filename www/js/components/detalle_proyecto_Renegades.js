...
<div style="background-color: #fafafa;">
  ...
  <div class="md-layout md-gutter" style="padding: 2%; border-bottom: 1px solid #f2f2f2;">
    ...
    <div class="md-layout-item"> <span class="md-title" style="text-transform: initial;">Renegades 3</span><br></div>
    <div class="md-layout-item"></div>

<md-card-media style="padding: 0px 16px 16px;">
                  <div class="md-layout md-gutter">
                  <div class="md-subhead" style="text-align:justify; text-transform: capitalize;">Some fun creatures.</div></div>
  </div>
   ...
   <div class="card-expansion" style="padding-top: 20px;">
    ...
    <div class="md-layout-item" style="padding-bottom: 16px;"><img src="img/projects/163d01.jpg" alt="People"></div>
    <div class="md-layout-item" style="padding-bottom: 16px;"><img src="img/projects/163d02.jpg" alt="People"></div>
     <div class="md-layout-item" style="padding-bottom: 16px;"><img src="img/projects/163d03.jpg" alt="People"></div>
