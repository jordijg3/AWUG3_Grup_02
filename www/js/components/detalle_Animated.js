...
const AnimatedTemplate = {props: [], 
    ...
    mounted: function(){
                 // The iframe
                  ...
                  var version = '1.0.0';
                  // Model to load
                  var urlid = '8993602ca91f4c499e690e5dae19f978';
...
<div style="background-color: #fafafa;">
  ...
  <div class="md-layout md-gutter" style="padding: 2%; border-bottom: 1px solid #f2f2f2;">
    ...
    <div class="md-layout-item"> <span class="md-title" style="text-transform: initial;">Animated humanoid robot</span><br></div>
    <div class="md-layout-item"></div>

<md-card-media style="padding: 0px 16px 16px;">
                  <div class="md-layout md-gutter">
                  <div class="md-subhead" style="text-align:justify; text-transform: capitalize;">A 3D animated character.</div></div>
  </div>
  ...
  <div class="md-layout">
   ...
   <div class="card-expansion" style="padding-top: 20px;">
    ...
    <div class="md-layout-item" style="padding-bottom: 16px;"><img src="img/projects/253d02.jpg" alt="People"></div>
    <div class="md-layout-item" style="padding-bottom: 16px;"><img src="img/projects/253d03.jpg" alt="People"></div>
     <div class="md-layout-item" style="padding-bottom: 16px;"><img src="img/projects/253d04.jpg" alt="People"></div>
