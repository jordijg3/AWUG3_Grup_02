...
const ThanosTemplate = {props: [], 
    ...
    mounted: function(){
                 // The iframe
                  ...
                  var version = '1.0.0';
                  // Model to load
                  var urlid = 'e22aba6c046b47b79a55640fc2df40b6';
...
<div style="background-color: #fafafa;">
  ...
  <div class="md-layout md-gutter" style="padding: 2%; border-bottom: 1px solid #f2f2f2;">
    <div class="md-layout-item md-size-15" style="text-align:center" @click="goToPerfilEvolve()"><md-icon class="md-size-1x">keyboard_arrow_left</md-icon></div>
    <div class="md-layout-item"> <span class="md-title" style="text-transform: initial;">Thanos</span><br></div>
  ...
  <div class="md-layout">
   ...
   <div class="card-expansion" style="padding-top: 20px;">
    ...
    <div class="md-layout-item" style="padding-bottom: 16px;"><img src="img/projects/23d02.jpg" alt="People"></div>
    <div class="md-layout-item" style="padding-bottom: 16px;"><img src="img/projects/23d03.jpg" alt="People"></div>
     <div class="md-layout-item" style="padding-bottom: 16px;"><img src="img/projects/23d04.jpg" alt="People"></div>
