var listaJson5 = [
    ...
    {idproyecto: "49", nombre: "Renegades 1", descripcion: "Some fun creatures", img1:"img/projects/143d01.jpg", img2:"img/projects/143d02.jpg", img3:"img/projects/143d03.jpg"},
    {idproyecto: "50", nombre: "Renegades 2", descripcion: "Some fun creatures", img1:"img/projects/153d01.jpg", img2:"img/projects/153d02.jpg", img3:"img/projects/153d03.jpg"},
    {idproyecto: "51", nombre: "Renegades 3", descripcion: "Some fun creatures", img1:"img/projects/163d01.jpg", img2:"img/projects/163d02.jpg", img3:"img/projects/163d03.jpg"},
...
const MarkTemplate = {props: [], 
        ...
        created: function(){
            this.proyectosperfiles = listaJson5;
        ...
        methods: {
            ...
            goToSeguidorMark: function(){                
                    this.$router.push('seguidor_mark');
                },
            
            goToSeguidoMark: function(){                
                    this.$router.push('seguido_mark');
                },
        ...
        <div style="background-color: #fafafa;">
              ...
              <div class="md-layout md-gutter" style="padding: 5%;">
                    ...
                    <div class="md-layout-item md-size-25">
                        <md-avatar class="md-large" style="width: 100%;height: 100%;">
                                <img src="img/user/fotop7.jpg" alt="People">
                        </md-avatar>
                    </div>

                    <div class="md-layout-item" style="margin-top:3%"> 
                    <span class="md-title" style="text-transform: initial;">Mark Case</span><br>
              ...
              <div class="md-layout md-gutter" style="padding: 0% 5% 5% 5%;">
                    ...
                    <div class="md-layout-item" style="text-align:center;">
                        ...
                        <span class="md-caption"  @click="goToSeguidoMark()">Seguidos</span>
                    </div>

                     <div class="md-layout-item" style="text-align:center;">
                        <span class="md-body-1"><b>2</b></span><br>
                        <span class="md-caption" @click="goToSeguidorMark()">Seguidores</span>
                    </div>
                 ...
                 <md-tabs md-alignment="centered" class="md-transparent" style="border-top: 1px solid #efefef;height: 100%; background-color: rgb(250, 250, 250);">
                      ...
                      <md-tab id="tab-proyectos" md-label="Proyectos" style="border-bottom: 1px solid #f2f2f2; background-color:#fafafa; height: 658px;">
                                  ...
                                  <div class="card-expansion"  @click="goToRenegades()" style="padding-bottom: 16px;" v-for="proyectoperfiles in proyectosperfiles">
